...
\hypersetup{unicode=true,
            pdftitle={Online Notes for ACTS 131},
            pdfauthor={John Garza},
            pdfborder={0 0 0},
            breaklinks=true}
...
\setlength{\droptitle}{-2em}
  \title{Online Notes for ACTS 131}
...
\chapter{Multivariable Distributions}\label{multivariable-distributions}

\chapter{Functions of a Random
...
\section{Slide with Bullets}\label{slide-with-bullets}
...
\section{Slide with R Output}\label{slide-with-r-output}
...
\section{Slide with Plot}\label{slide-with-plot}
